...
impl Insurance {
    ...
    ///
    /// Emits a `PolicyCreatedEvent` with topics
    /// `("Remitwise", Transaction=0, Medium=1, "created")`.
    ...
    ///
    /// Emits a `PolicyDeactivatedEvent` with topics
    /// `("Remitwise", State=1, Medium=1, "deactive")`.
    ...
    ///
    /// Emits a `PremiumPaidEvent` with topics
    /// `("Remitwise", Transaction=0, Low=0, "paid")`.
